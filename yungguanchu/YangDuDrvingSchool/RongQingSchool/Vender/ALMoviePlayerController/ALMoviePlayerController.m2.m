...
- (void)setFullscreen:(BOOL)fullscreen animated:(BOOL)animated {
    ...
    if (fullscreen) {
        ...
        [self rotateMoviePlayerForOrientation:UIInterfaceOrientationLandscapeRight animated:YES completion:^{
            [UIView animateWithDuration:animated ? fullscreenAnimationDuration : 0.0 delay:0.0 options:UIViewAnimationOptionCurveLinear animations:^{
                self.view.alpha = 1.f;
            } completion:^(BOOL finished) {
        ...
        [UIView animateWithDuration:animated ? fullscreenAnimationDuration : 0.0 delay:0.0 options:UIViewAnimationOptionCurveLinear animations:^{
            ...
            self.movieBackgroundView.transform = CGAffineTransformMakeRotation(0);
            self.movieBackgroundView.frame = CGRectMake(0, 0, UISCREEN_SIZE.width, 200);
            [self setFrame:CGRectMake(0, 0, UISCREEN_SIZE.width, 200)];
