    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        //我的收藏
            ...
            if([@"0" isEqualToString:self.detailType]){
                ...
                QuestionLibraryDao *dao = [[QuestionLibraryDao alloc] init];
                [dao openDataBase];
                self.dataAry = [dao selectCollectedQuestionByDetail_type:self.detailType];
                [dao closeDataBase];
            }
        ...
        //我的错题
            ...
            if([@"0" isEqualToString:self.detailType]){
                ...
                QuestionLibraryDao *dao = [[QuestionLibraryDao alloc] init];
                [dao openDataBase];
                self.dataAry = [dao selectWrongQuestionByDetail:self.detailType];
                [dao closeDataBase];
            }
            dispatch_async(dispatch_get_main_queue(), ^{
                self.bottomBar.hidden = YES;
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            QuestionLibraryItem *item = self.dataAry[_currentIndex];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(collectionView == self.collectionView){
        ...
        QuestionLibraryItem *questionItem = self.dataAry[indexPath.row];
        cell.questionItem = questionItem;
        
        cell.resultLb22.text = questionItem.detail_type;
        
        //    cell
        
        //问题描述
        [Utils autoHeightLabel2:cell.questionTextLb
                     withString:questionItem.question
        ...
        cell.optionTypeImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"option_type_%d",questionItem.option_type]];
        ...
        //多选提交按钮
        cell.commitBtn.hidden = !(questionItem.option_type == 1);
...
-(void)alertBack:(UIAlertView *)alert{
    int score = 0;
    for(QuestionLibraryItem *item in self.dataAry){
