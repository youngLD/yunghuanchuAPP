        ...
        if(index == 0){
            ...
            if(weakSelf.evaluationActionView5.star0<1){
                ...
                NSDictionary *postParam = [NSDictionary dictionaryWithObjectsAndKeys:
                                           ...
                                           @"",@"apcont",
                                           @"",@"apgrade",
                                           NSStringFromInt(weakSelf.evaluationActionView5.star0),@"sfg",
                                           NSStringFromInt(weakSelf.evaluationActionView5.star1),@"jdg",
                                           NSStringFromInt(weakSelf.evaluationActionView5.star2),@"txxyqdg",
                                           NSStringFromInt(weakSelf.evaluationActionView5.star3),@"zxg",
                                           NSStringFromInt(weakSelf.evaluationActionView5.star4),@"zpgang", nil];
        ...
        if(index == 0){
            ...
            if(weakSelf.evaluationActionView3.star0<1){
                ...
                NSDictionary *postParam = [NSDictionary dictionaryWithObjectsAndKeys:
                                           ...
                                           NSStringFromInt(weakSelf.evaluationActionView3.star0),@"jdg",
                                           NSStringFromInt(weakSelf.evaluationActionView3.star1),@"txxyqdg",
                                           NSStringFromInt(weakSelf.evaluationActionView3.star2),@"sfg",
                                           @"",@"zxg",
        ...
        if(index == 0){
            ...
            if(weakSelf.evaluationActionView1.star0<1){
                ...
                NSDictionary *postParam = [NSDictionary dictionaryWithObjectsAndKeys:
                                           [UserInfo shareUserInfo].uId,@"uid",
                                           weakSelf.selectedReservationEvaluationItem.TranOrderId,@"orid",
                                           NSStringFromInt(weakSelf.evaluationActionView1.star0),@"appscore",
                                           weakSelf.selectedReservationEvaluationItem.AppTypeNum,@"aptype",
                                           @"",@"apcont",
